...
export default function DashboardPage({ onAlert, onGoInsights }: DashboardPageProps) {
  ...
  return <>
    <div className="card-grid" style={{marginBottom:16}}>
      {/* 1. GMV 卡 — 加环比微趋势线 + 日均 */}
      <div className="card" style={{borderRadius:'var(--radius-card)',boxShadow:'0 1px 6px rgba(0,0,0,0.04)',containerType:'inline-size',aspectRatio:'1',display:'flex',flexDirection:'column',padding:16,overflow:'hidden'}}>
      ...
      <div className="card" style={{borderRadius:'var(--radius-card)',boxShadow:'0 1px 6px rgba(0,0,0,0.04)',containerType:'inline-size',aspectRatio:'1',display:'flex',flexDirection:'column',padding:16}}>
