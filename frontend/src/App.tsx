        ...
        <div style={{display:'flex',flexDirection:'column',minHeight:'100svh',padding:'calc(env(safe-area-inset-top, 0px) + 40px) 24px calc(24px + env(safe-area-inset-bottom, 20px))',overflowY:'auto',boxSizing:'border-box'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:14,marginBottom:32}}>
            {[
              ...
              return <div key={card.page} className="clickable" style={{background:'var(--card)',borderRadius:'var(--radius-card)',padding:16,textAlign:'center',cursor:'default',border:'0.5px solid var(--border)',boxShadow:'0 1px 4px rgba(0,0,0,0.04)'}}>
