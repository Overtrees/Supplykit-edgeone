...
CREATE TABLE IF NOT EXISTS `batches` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '', warehouse_type VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', prod_date VARCHAR(255) DEFAULT '', exp_date VARCHAR(255) DEFAULT '', qty BIGINT DEFAULT 0, created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `cleansing_errors` (id BIGINT PRIMARY KEY AUTO_INCREMENT, task_id VARCHAR(255) DEFAULT '', row_index BIGINT DEFAULT 0, source_file VARCHAR(255) DEFAULT '', error_type VARCHAR(255) DEFAULT '', field_name VARCHAR(255) DEFAULT '', raw_value VARCHAR(255) DEFAULT '', error_message VARCHAR(255) DEFAULT '', raw_data VARCHAR(255) DEFAULT '{}', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `cleansing_templates` (id BIGINT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) NOT NULL, doc_type VARCHAR(255) DEFAULT 'order', mapping VARCHAR(255) DEFAULT '{}', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `custom_fields` (id BIGINT PRIMARY KEY AUTO_INCREMENT, target VARCHAR(255) NOT NULL, `key` VARCHAR(255) NOT NULL, label VARCHAR(255) DEFAULT '', type VARCHAR(255) DEFAULT 'string', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `daily_sales_snapshot` (id BIGINT PRIMARY KEY AUTO_INCREMENT, date VARCHAR(255) NOT NULL, channel VARCHAR(255) DEFAULT 'jd', sku VARCHAR(255) NOT NULL, warehouse VARCHAR(255) DEFAULT '', order_count BIGINT DEFAULT 0, UNIQUE(date, channel, sku, warehouse)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `daily_stats` (id BIGINT PRIMARY KEY AUTO_INCREMENT, date VARCHAR(255) NOT NULL, channel VARCHAR(255) DEFAULT 'jd', store VARCHAR(255) DEFAULT '', sku VARCHAR(255) DEFAULT '', order_status VARCHAR(255) DEFAULT '', gmv DOUBLE DEFAULT 0, order_count BIGINT DEFAULT 0, quantity BIGINT DEFAULT 0, UNIQUE(date, channel, store, sku, order_status)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `disposal_records` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '', warehouse_type VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', level VARCHAR(255) DEFAULT '', turnover_days DOUBLE DEFAULT 0, reason VARCHAR(255) DEFAULT '', action VARCHAR(255) DEFAULT '', note VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `events` (id BIGINT PRIMARY KEY AUTO_INCREMENT, event_type VARCHAR(255) NOT NULL, entity_type VARCHAR(255) DEFAULT '', entity_id VARCHAR(255) DEFAULT '', title VARCHAR(255) DEFAULT '', payload VARCHAR(255) DEFAULT '{}', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `inbound_records` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) DEFAULT '', product_name VARCHAR(255) DEFAULT '', quantity BIGINT DEFAULT 0, supplier VARCHAR(255) DEFAULT '', inbound_date VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , prod_date VARCHAR(255) DEFAULT '', exp_date VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `inventory` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) NOT NULL, product_name VARCHAR(255) DEFAULT '', store VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '', available_qty BIGINT DEFAULT 0, locked_qty BIGINT DEFAULT 0, in_transit_qty BIGINT DEFAULT 0, safety_qty BIGINT DEFAULT 0, safety_days DOUBLE DEFAULT 0, warehouse_type VARCHAR(255) DEFAULT 'platform', raw_data VARCHAR(255) DEFAULT '', source VARCHAR(255) DEFAULT '', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , channel VARCHAR(255) DEFAULT 'jd', beginning_stock BIGINT DEFAULT 0, month_inbound BIGINT DEFAULT 0, month_outbound BIGINT DEFAULT 0, turnover_days DOUBLE DEFAULT 0, c_transit BIGINT DEFAULT 0, weight DOUBLE DEFAULT 0, volume DOUBLE DEFAULT 0, barcode VARCHAR(255) DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `orders` (id BIGINT PRIMARY KEY AUTO_INCREMENT, order_no VARCHAR(255) NOT NULL, store VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '', sku VARCHAR(255) DEFAULT '', product_name VARCHAR(255) DEFAULT '', quantity BIGINT DEFAULT 0, unit_price DOUBLE DEFAULT 0, total_amount DOUBLE DEFAULT 0, data_source VARCHAR(255) DEFAULT '', order_status VARCHAR(255) DEFAULT '', ordered_at VARCHAR(255) DEFAULT '', platform VARCHAR(255) DEFAULT '', supplier VARCHAR(255) DEFAULT '', remark VARCHAR(255) DEFAULT '', parent_order_no VARCHAR(255) DEFAULT '', raw_data VARCHAR(255) DEFAULT '', source VARCHAR(255) DEFAULT '', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , channel VARCHAR(255) DEFAULT 'jd', paid_at VARCHAR(255) DEFAULT '', barcode VARCHAR(255) DEFAULT '', deleted_at VARCHAR(255) DEFAULT '', freight_amount DOUBLE DEFAULT 0, subsidy_amount DOUBLE DEFAULT 0, tax_amount DOUBLE DEFAULT 0, discount_amount DOUBLE DEFAULT 0, actual_amount DOUBLE DEFAULT 0) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `outbound_records` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) DEFAULT '', product_name VARCHAR(255) DEFAULT '', quantity BIGINT DEFAULT 0, target_warehouse VARCHAR(255) DEFAULT '', outbound_date VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , prod_date VARCHAR(255) DEFAULT '', exp_date VARCHAR(255) DEFAULT '', warehouse VARCHAR(255) DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `products` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) NOT NULL, product_name VARCHAR(255) DEFAULT '', store VARCHAR(255) DEFAULT '', category VARCHAR(255) DEFAULT '', price DOUBLE DEFAULT 0, box_qty BIGINT DEFAULT 1, status VARCHAR(255) DEFAULT 'active', supplier_code VARCHAR(255) DEFAULT '', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, barcode VARCHAR(255) DEFAULT '', weight DOUBLE DEFAULT 0, volume DOUBLE DEFAULT 0, channel VARCHAR(255) DEFAULT 'jd', unit VARCHAR(255) DEFAULT '', deleted_at VARCHAR(255) DEFAULT '', best_before VARCHAR(255) DEFAULT '', brand VARCHAR(255) DEFAULT '', UNIQUE(sku, channel)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `purchase_orders` (id BIGINT PRIMARY KEY AUTO_INCREMENT, sku VARCHAR(255) NOT NULL, store VARCHAR(255) DEFAULT '', product_name VARCHAR(255) DEFAULT '', suggested_qty BIGINT DEFAULT 0, actual_qty BIGINT DEFAULT 0, arrival_date VARCHAR(255) DEFAULT '', status VARCHAR(255) DEFAULT 'pending', channel VARCHAR(255) DEFAULT 'jd', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `quality_logs` (id BIGINT PRIMARY KEY AUTO_INCREMENT, log_type VARCHAR(255) DEFAULT '', level VARCHAR(255) DEFAULT '', message VARCHAR(255) DEFAULT '', details VARCHAR(255) DEFAULT '', source VARCHAR(255) DEFAULT '', entity_type VARCHAR(255) DEFAULT '', entity_id VARCHAR(255) DEFAULT '', field_name VARCHAR(255) DEFAULT '', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `replenishment_config` (id BIGINT PRIMARY KEY AUTO_INCREMENT, `key` VARCHAR(255) NOT NULL, value VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, UNIQUE(`key`, channel)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `replenishment_config_history` (id BIGINT PRIMARY KEY AUTO_INCREMENT, `key` VARCHAR(255) NOT NULL, old_value VARCHAR(255) DEFAULT '', new_value VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', mode VARCHAR(255) DEFAULT '', operator VARCHAR(255) DEFAULT 'web', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `rules` (id BIGINT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) DEFAULT '', event VARCHAR(255) DEFAULT '', condition_json VARCHAR(255) DEFAULT '{}', alert_type VARCHAR(255) DEFAULT '', alert_title VARCHAR(255) DEFAULT '', alert_desc VARCHAR(255) DEFAULT '', severity VARCHAR(255) DEFAULT 'warning', is_active BIGINT DEFAULT 1, owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , mode VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', deleted_at VARCHAR(255) DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `suppliers` (id BIGINT PRIMARY KEY AUTO_INCREMENT, supplier_code VARCHAR(255) UNIQUE NOT NULL, supplier_name VARCHAR(255) DEFAULT '', contact_person VARCHAR(255) DEFAULT '', contact_phone VARCHAR(255) DEFAULT '', score BIGINT DEFAULT 0, status VARCHAR(255) DEFAULT 'active', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP , channel VARCHAR(255) DEFAULT 'jd', brand VARCHAR(255) DEFAULT '') ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `sync_tasks` (id BIGINT PRIMARY KEY AUTO_INCREMENT, task_id VARCHAR(255) DEFAULT '', task_type VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT 'pending', params VARCHAR(255) DEFAULT '{}', result VARCHAR(255) DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', owner_id VARCHAR(255) DEFAULT '', created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `users` (id BIGINT PRIMARY KEY AUTO_INCREMENT, username VARCHAR(255) UNIQUE NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(255) DEFAULT 'user', is_active BIGINT DEFAULT 1, created_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP, updated_at VARCHAR(255) DEFAULT CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE IF NOT EXISTS `warehouse_registry` (id BIGINT PRIMARY KEY AUTO_INCREMENT, warehouse VARCHAR(255) NOT NULL DEFAULT '', warehouse_type VARCHAR(255) NOT NULL DEFAULT '', channel VARCHAR(255) DEFAULT 'jd', UNIQUE(warehouse, channel)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
